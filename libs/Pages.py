...
class Shoppage():
    def __init__(self, gameLancher, user):
        ...
        self.PRICE1 = pygame.transform.scale(pygame.image.load("img/S_price1.png"), (125, 40))
        self.STAR = pygame.transform.scale(pygame.image.load("img/Star.png"), (100,120))
        self.SHILE = pygame.transform.scale(pygame.image.load("img/ic_shiled.png"), (120,120))
        self.COINS = pygame.transform.scale(pygame.image.load("img/ic_coin.png"), (120,120))
        self.ARROW = pygame.transform.scale(pygame.image.load("img/arrow.png"), (120,120))
        self.pricelucky = int(int(user.coins)*0.2)                 #Giá bùa may mắn
        self.pricestar = int(int(user.coins)*0.3)               #Giá bùa ngôi sao hi vọng
        self.priceshile = int(int(user.coins)*0.3)
        self.PRICE_LUCKY = Button(410,370,125,40,str(self.pricelucky))
        self.PRICE_STAR = Button(410+220,370,120,40,str(self.pricestar))
        self.PRICE_SHILE = Button(410, 370+250, 125, 40, str(self.priceshile))
        self.BUY = TextView(415,300,125,40,"Buy")
        self.TITLE = TextView(395,200,125,40,"ADD MONEY")
        self.BTN_LUCKY = Button(395,370,125,40)
        self.BTN_STAR = Button(395+220,370,125,40)
        self.BTN_SHILE = Button(410, 370+250, 125, 40)
        self.BTN_BUY = Button(395,300,125,40)
        self.BTN_COINS = Button(600,500,120,120)
        self.BTN_ARROW = Button(395,500,120,120)
        self.appear_shop = False
        self.use_star  = False
        self.use_lucky = False
        self.use_shile = False
        self.add = False
        self.buy = False
        ...
        self.add_money = InputBox(400,250,200,40,"0", isdigit=True)
        self.btn_addmoney = Button(400,200,200,40)
        self.addmoney = 0
        self.tag = 1
    ...
    def DrawShop(self):
        ...
        if self.tag ==  1:
            self.SCREEN.blit(self.SHELF, (380, 200))
            if self.use_lucky:
                self.SCREEN.blit(self.PRICE, (395, 370))
            else:
                self.SCREEN.blit(self.PRICE1, (395, 370))
            self.SCREEN.blit(self.LUCKY, (410, 220))
            self.SCREEN.blit(self.SHELF, (380 + 220, 200))
            if self.use_star:
                self.SCREEN.blit(self.PRICE, (395 + 220, 370))
            else:
                self.SCREEN.blit(self.PRICE1, (395 + 220, 370))
            self.SCREEN.blit(self.STAR, (410 + 220, 220))
            self.SCREEN.blit(self.SHELF, (380, 200 + 250))
            if self.use_shile:
                self.SCREEN.blit(self.PRICE, (395, 370 + 250))
            else:
                self.SCREEN.blit(self.PRICE1, (395, 370 + 250))
            self.SCREEN.blit(self.SHILE, (400, 220 + 250))
            self.SCREEN.blit(self.COINS, (600, 500))
            self.PRICE_SHILE.show()
            self.PRICE_LUCKY.show()
            self.PRICE_STAR.show()
        if self.tag == 2:
            self.add_money.draw(self.SCREEN)
            if self.buy:
                self.SCREEN.blit(self.PRICE, (395, 300))
            else:
                self.SCREEN.blit(self.PRICE1, (395, 300))
            self.SCREEN.blit(self.ARROW, (395,500))
            self.BUY.show()
            self.TITLE.show()
        pass
    '''def resize(self, x ,y):
