...
class Racer(pygame.sprite.Sprite):
    """ Doi tuong dua """
    def __init__(self, x, y, game, pack ="ic_snail", num = "trong"):
        self.pack_sprite = pack
        self.num = num
        name = "img/"
        ic_name = name + pack + str(num) + ".png"
        self.img = pygame.transform.scale(pygame.image.load(ic_name), (40,40))
        self.x = x
        self.y = y
        self.stun = 0
        self.time = 0
    ...
    def updatespeed(self):
        self.speed = random.randrange(-1, 15) / 10
    def draw(self):
