...
class INIT_GAME():
    ...
    def __init__(self) -> None:
        ...
        self.list_tv = (View(self.GAME_WIDTH / 3 - self.GAME_WIDTH / 20, self.GAME_HEIGHT / 2 + self.GAME_HEIGHT / 20 * 1, color="#65d06f"),
                   View(self.GAME_WIDTH / 3 - self.GAME_WIDTH / 20, self.GAME_HEIGHT / 2 + self.GAME_HEIGHT / 20 * 2, color="#65d06f"),
                   View(self.GAME_WIDTH / 3 - self.GAME_WIDTH / 20, self.GAME_HEIGHT / 2 + self.GAME_HEIGHT / 20 * 3, color="#65d06f"))
    ...
    def load_img(self, link, scale_x, scale_y):
        ...
        img = pygame.transform.scale(img, (int(scale_x * (self.SCALE_X)),
                                           int(scale_y * (self.SCALE_Y))))
        return img
