...
from libs.global_variables import *
from libs.Widgets import *
#>>>>>>> 1e61b0f2fdf0f2db10d6b5090d42102d665c8f3e
import pygame
import time
import time
import math
...
#>>>>>>> 1e61b0f2fdf0f2db10d6b5090d42102d665c8f3e
    ...
    k = 170
    h = 40
    racers = (Racer(0, k + 0 * h, gameLancher, "ic_snail", 0),
              Racer(0, k + 1 * h, gameLancher, "ic_snail", 1),
              Racer(0, k + 2 * h, gameLancher, "ic_snail", 2),
              Racer(0, k + 3 * h, gameLancher, "ic_snail", 3),
              Racer(0, k + 4 * h, gameLancher, "ic_snail", 4),
              Racer(0, k + 5 * h, gameLancher, "ic_snail", 5))
